namespace Objectivity.AutoFixture.XUnit2.AutoNSubstitute.Tests.Attributes
{
    ...
    public class MemberAutoNSubstituteDataAttributeTests
    {
        ...
        public void WhenConstructorIsInvoked_ThenHasSharedFixture(Fixture fixture)
        {
            // Arrange
            // Act
            var attribute = new MemberAutoNSubstituteDataAttribute(fixture.Create<string>());
        ...
        {
            // Arrange
            var attribute = new MemberAutoNSubstituteDataAttribute("TestData");
            var methodInfo = typeof(MemberAutoNSubstituteDataAttributeTests).GetMethod("TestMethod");
            ...
            for (var i = data.Count - 1; i >= 0; i--)
            {
                ...
                result[numberOfParameters - 1].GetType().Name.Should().StartWith("IDisposableProxy", "that way we know it was mocked with NSubstitute.");
            }
        }
        ...
        public void GivenIgnoreVirtualMembers_WhenGetDataIsInvoked_ThenFixtureIsCustomizedCorrectly(bool ignoreVirtualMembers)
        {
            ...
            var attribute = new MemberAutoNSubstituteDataAttribute(fixture.Object, "TestData")
            {
        ...
        public void GivenUninitializedFixture_WhenConstructorIsInvoked_ThenExceptionIsThrown()
        {
            ...
            // Act
            // Assert
            Assert.Throws<ArgumentNullException>(() => new MemberAutoNSubstituteDataAttribute(uninitializedFixture, fixture.Create<string>()));
        }
        ...
        public void GivenUninitializedMemberName_WhenConstructorIsInvoked_ThenExceptionIsThrown()
        {
            ...
            // Act
            // Assert
            Assert.Throws<ArgumentNullException>(() => new MemberAutoNSubstituteDataAttribute(memberName));
        }


        [MemberAutoNSubstituteData("TestData")]
